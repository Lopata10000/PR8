...
public class ActorDao implements Dao {
    ...
    public void saveNewEntity(Entity entity) {
        ...
        String sqlSave = "INSERT INTO Actors (First_Name, Last_Name, Birth_Date) VALUES (?, ?, ?)";
        ...
        try (Connection connection = DbUtil.getConnection();
            ...
            statement.setObject(3, actorEntity.getBirthDate());
    ...
    public void updateEntityById(int id, Entity entity) {
        ActorEntity actorEntity = (ActorEntity) entity;
        String sqlUpdate = "UPDATE Actors SET First_Name = ?, Last_Name = ?, Birth_Date = ? WHERE Id = ?";
    ...
    public ActorEntity findById(int id) {
        String sqlFindById = "SELECT Id, First_Name, Last_Name, Birth_Date FROM Actors WHERE Id = ?";
    ...
    public List<ActorEntity> findAll() {
        String sqlFindAll = "SELECT Id, First_Name, Last_Name, Birth_Date FROM Actors";
